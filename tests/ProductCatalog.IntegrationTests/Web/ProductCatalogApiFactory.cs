...
public sealed class ProductCatalogApiFactory : WebApplicationFactory<ProductCatalog.Web.Program>
{
    ...
    private readonly string _databasePath = Path.Combine(Path.GetTempPath(), $"productcatalog-api-{Guid.NewGuid():N}.db");
    ...
    public ProductCatalogApiFactory()
    {
